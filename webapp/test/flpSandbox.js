		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "HoGent Demo",
									"targetURL": "#hogenthogentdemo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"hogenthogentdemo-display": {
								"semanticObject": "hogenthogentdemo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=hogent.hogentdemo",
									"url": sap.ui.require.toUrl("hogent/hogentdemo")
								}
							}
						}
					}
